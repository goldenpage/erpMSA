...
class JwtAuthenticationFilterTest {
    ...
    void 유효한_토큰이면_계정정보를_요청에_저장한다() throws Exception {
        MockHttpServletRequest request = request("/inventories");
    ...
    @Test
    void 토큰이_없으면_표준_401을_반환한다() throws Exception {
        MockHttpServletResponse response = new MockHttpServletResponse();
        AtomicBoolean continued = new AtomicBoolean();
    ...
    @Test
    void 잘못된_토큰이면_표준_401을_반환한다() throws Exception {
        MockHttpServletRequest request = request("/inventories");
    ...
    @Test
    void Actuator는_토큰없이_통과한다() throws Exception {
        MockHttpServletResponse response = new MockHttpServletResponse();
        AtomicBoolean continued = new AtomicBoolean();
