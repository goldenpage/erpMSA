...
class InventoryServiceTest {
    ...
    void 초기재고와_원장을_함께_생성한다() {
        when(inventoryRepository.existsByAccountIdAndFoodMaterialId(10L, 100L))
            .thenReturn(false);
        ...
        assertThat(response.foodMaterialId()).isEqualTo(100L);
    ...
    void 재고수량을_변경하고_원장을_기록한다() {
        ...
        when(inventoryRepository.findByAccountIdAndFoodMaterialId(10L, 100L))
    ...
    void 다른_계정의_재고는_조회할_수_없다() {
        when(inventoryRepository.findByAccountIdAndFoodMaterialId(20L, 100L))
    ...
    private InventoryEntity inventory(
        ...
        return persistedInventory(
            InventoryEntity.create(accountId, foodMaterialId, quantity),
            id,
            version
        );
    }
