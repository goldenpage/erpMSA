package com.oopsw.menusservice.advice;

import com.oopsw.menusservice.api.ApiErrorCode;
import com.oopsw.menusservice.api.ApiErrorResponse;
import com.oopsw.menusservice.api.ApiException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleUnexpectedException(
        ...
        log.error(
            "처리되지 않은 MenusService API 예외가 발생했습니다. path={}",
            request.getRequestURI(),
            exception
        );
