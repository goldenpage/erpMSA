package com.oopsw.disposalsservice.advice;

import com.oopsw.disposalsservice.api.ApiErrorCode;
import com.oopsw.disposalsservice.api.ApiErrorResponse;
import com.oopsw.disposalsservice.api.ApiException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleDataConflict(
        ...
        return response(ApiErrorCode.CONCURRENT_MODIFICATION, request);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleUnexpectedException(
        ...
        log.error(
            "처리되지 않은 DisposalsService API 예외가 발생했습니다. path={}",
            request.getRequestURI(),
            exception
        );
